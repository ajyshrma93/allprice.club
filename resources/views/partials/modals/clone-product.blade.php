            ...
            <form action="{{route('products.clone')}}" class="theme-form" id="clone_product_form" onsubmit="event.preventDefault();" method="POST">
                ...
                <div class="mb-3 row">
                    ...
                    <div class=" col-xxl-8 col-xl-6 col-md-12 col-12 field-area">
                        <div class="input-group mobile-design-change bootstrap-touchspin @error('price') is-invalid @enderror">
                            ...
                            <button onclick="decrease('#clone_product_price',true,0.1)" class="btn btn-custom-width btn-primary btn-square bootstrap-touchspin-down touchspin-btn" type="button" data-bs-original-title="" title="">0.1</i></button>
                            <button onclick="decrease('#clone_product_price',true,0.01)" class="btn btn-custom-width btn-primary btn-square bootstrap-touchspin-up touchspin-btn" type="button" data-bs-original-title="" title="">0.01</button>
                        </div>
                        @error('price')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-6 d-flex  field-area">
                        <div class=" offer-price-checkbox text-nowrap">
                            <div>
                                <input type="checkbox" id="clone_product_duty_free" name="is_duty_free">
                                <label for="clone_product_offer" style="font-size: 12px; color: #898989">Duty Free</label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mb-3">
                    <div class="product-img text-center">
                        <img src="{{asset('assets/images/no-data-available.png')}}" alt="product image" width="100px" id="clone_product_image_preview" height="100px">
                    </div>
                </div>
