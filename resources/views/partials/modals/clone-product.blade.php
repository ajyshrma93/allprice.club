                ...
                <div class="row">
                    <div class="col-6">
                        <div class="mb-3">
                            ...
                            <select name="category_id" class="js-example-basic-single col-sm-12" id="clone_product_category">
                    ...
                    <div class="col-6">
                        <div class="mb-3">
                            ...
                            <select name="shop_id" class="js-example-basic-single col-sm-12" id="clone_product_shop">
