    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content p-4">
            ...
            <form class="theme-form">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <input type="file" name="product_images" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" aria-label="Upload" multiple="" data-bs-original-title="" title="">
                    </div>
                </div>
            </form>
            <div class="modal-footer border-0 text-center text-sm-end">
                ...
                <button class="btn btn-primary" data-bs-original-title="" title="">Add Items</button>
            </div>
        </div>
    </div>
</div>
